...
"""
1. Write a program to print all the numbers between 
1000 and 2000 which are divisible by 7 but are not a multiple of 5.
...
3 .Write a program to print table of a number accepted from user , using while loop
